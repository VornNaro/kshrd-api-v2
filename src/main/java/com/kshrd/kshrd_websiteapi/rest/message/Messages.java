...
public class Messages {
    ...
    private static final String FIND_SUCCESS = "You have select all data successfully";
    private static final String ADD_SUCCESS = "You have add data successfully";
    private static final String GET_ONE_SUCCESS = "You have found the data";
    private static final String UPDATE_SUCCESS = "You have update data successfully";
    private static final String DELETE_SUCCESS = "You have delete data successfully";
